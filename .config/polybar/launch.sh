...
export POLY_WS_ICON_0="1;%{F$foreground_alt}%{F-} com"
export POLY_WS_ICON_1="2;%{F$foreground_alt}%{F-} web"
export POLY_WS_ICON_2="3;%{F$foreground_alt}%{F-} dev"
export POLY_WS_ICON_3="4;%{F$foreground_alt}%{F-} ent"
...
export POLY_WS_ICON_9="10;%{F$foreground_alt}%{F-} mus"
